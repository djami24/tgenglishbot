"""
Ingliz tili (General English) postini Google Gemini orqali generatsiya qilib,
...
FACT_TOPICS = [
    ...
    "ingliz tilida so'zlashuvchi mamlakatlar haqida qiziqarli fakt",
...
TIP_TOPICS = [
    ...
    "listening ko'nikmasini oshirish maslahati",
    "speaking paytida ikkilanmaslik uchun maslahat",
...
4. Oxirida qisqa maslahat""",
    ...
    "fact": {
        "topics": FACT_TOPICS,
        "emoji": "💡",
        "instruction": """Bu QIZIQARLI FAKT posti. Format:
1. Qiziqarli sarlavha (emoji bilan)
...
4. Oxirida qisqa xulosa yoki qiziqarli savol""",
    ...
    "tip": {
        "topics": TIP_TOPICS,
        "emoji": "🎯",
        "instruction": """Bu TIP (maslahat) posti. Format:
1. Qiziqarli sarlavha (emoji bilan)
...
def send_to_telegram(text: str) -> None:
    ...
    share_url = f"https://t.me/share/url?url={CHANNEL_LINK}&text=Ingliz+tili+darslari"
    ...
    payload = {
        ...
        "reply_markup": {
            "inline_keyboard": [
                ...
                [{"text": "📢 @djami_teacher", "url": CHANNEL_LINK}],
            ]
        },
    }
    resp = requests.post(url, json=payload, timeout=30)
